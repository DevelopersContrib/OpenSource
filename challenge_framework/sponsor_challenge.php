								...
								<div class="post-left-content">
									<div class="row-fluid">
										<div class="wrap-post-main-content profile-row">
											...
											<br clear="all">
											<?php include 'sponsorship_table.php';?>	
											<br clear="all">
										</div>
									</div><!--End-->
									<div class="row-fluid">
										<div class="wrap-post-main-content profile-row">
											<h2>Submit Sponsorship</h2>
											...
											<form method="POST" enctype="multipart/form-data" id="sponsorform" action = "javascript:saveSponsorship()">
											    <div class="appli-box" >
													<h5>Sponsor Name * </h5>
													<input type="text" name="sponsor_name" id="sponsor_name" class="in-name" />
													<div class="message-error" id="error1" style="display:none;color:red"><span>Error messages</span></div>
												</div>
												
												<div class="appli-box" >
													<h5>Sponsor URL * </h5>
													<input type="text" name="sponsor_url" id="sponsor_url" class="in-name" />
												...
												<div id="type_2" style="display:none;">
													<div class="appli-box" >
														<h5>Message * </h5>
														<textarea name="appli-desc" id="message_type2" class="in-desc"></textarea>
														<div class="message-error" id="error5" style="display:none;color:red"><span>Error messages</span></div>
													</div>												
												</div>
											
												<div class="appli-box" id="btn-check" style="display:none;">
													<input type="checkbox" name="sendback" id="sendback" value="1">&nbsp;Send me email copy of this
												</div>
												
												<input type="hidden" id="chall_id" name="chall_id" value="<?=$challengeid?>">
												<input type="hidden" id="slug" name="slug" value="<?=$slug?>">
												<button class="btn btn-small btn-warning" id="submit" style="display:none">Submit</button>
												<br>

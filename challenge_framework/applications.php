								...
								<div class="post-left-content">
									<div class="row-fluid">
										<div class="wrap-post-main-content profile-row">
											<h2>APPLICATION GALLERY FOR <?php echo $challenge_title?></h2>
											
											<? $appArray = $dir->GetSubmissions($challengeid); ?>
											
											
											<? for($i=0; $i < sizeof($appArray) ; $i++){ ?>
												
												<? $__photo = $appArray[$i]['Photo']; ?>
												<? $__title = $appArray[$i]['AppName']; ?>
												<? $__slug  = $appArray[$i]['Slug']; ?>
												<? $__by  = $appArray[$i]['postedby']; ?>
												<? $__winner  = $appArray[$i]['AppWinner']; ?>
												<? $__description = $appArray[$i]['AppDesc'];?>
													...
													<div class="row-fluid application-listing">
														<div class="wrap-listing">
															<div class="row-fluid">
																<div class="span12">
																	<div class="span4">
																		<a class="sub-app-img" href="<?=$siteurl?>/application/<?=$__slug?>" target="_blank"><img id="content" name="#content-target" src="<?=$__photo;?>" style="height: 120px;width: 97%;"></a>
																	</div><!--End of app image-->
																	<div class="span8 application-ttle ">
																		<div class="row-fluid">
																			<a class="sub-app-link" href="<?=$siteurl?>/application/<?=$__slug?>" target="_blank"><b><?=$__title;?></b></a> 
																		</div>
																		<div class="row-fluid">
																			<a class="sub-app-by" href="<?=$siteurl?>/user/<?=$__by?>" target="_blank"><p><?=$__by?></p></a>
																			<p><?
															...
															$__description = substr($__description, 0, strrpos(substr($__description, 0, $limit),' ')).'...';
																			...
																			echo stripslashes($__description);
																			
																			
																			
																			?></p>
																			<?if($__winner=='1') echo '<p style="color: orange;"><img src="'.$siteurl.'/img/winner.png" style="height: auto;width: auto;border: none;"><b>Challenge Winner!</b></p>';?>
																		</div>
